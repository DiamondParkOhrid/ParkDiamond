...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // BITE Nav
  'bite.nav.home': { en: 'Home', mk: 'Дома' },
  'bite.nav.menu': { en: 'Menu', mk: 'Мени' },
  'bite.nav.story': { en: 'Story', mk: 'Приказна' },
  'bite.nav.visit': { en: 'Visit', mk: 'Посети' },
  'nav.bite': { en: 'BITE Cafe', mk: 'BITE Кафе' },

  // BITE Footer
  'bite.footer.tagline': { en: 'Healthy food, great coffee, and good company in Ohrid.', mk: 'Здрава храна, одлично кафе и добро друштво во Охрид.' },
  'bite.footer.rights': { en: 'All rights reserved.', mk: 'Сите права се задржани.' },
  ...
  'bite.home.subheadline': { en: 'Healthy food, specialty coffee, and fresh juices — all in one place in Ohrid.', mk: 'Здрава храна, специјално кафе и свежи сокови — сè на едно место во Охрид.' },
  'bite.home.tagFood': { en: 'Food', mk: 'Храна' },
  'bite.home.tagCoffee': { en: 'Coffee', mk: 'Кафе' },
  'bite.home.tagTobacco': { en: 'Tobacco', mk: 'Тутун' },
  'bite.home.exploreCta': { en: 'Explore the Menu', mk: 'Истражи го менито' },
  'bite.home.introTitle': { en: 'Three reasons to walk in.', mk: 'Три причини да влезеш.' },
  'bite.home.introDesc': { en: 'BITE brings together what Ohrid was missing — fresh, healthy bites, carefully sourced coffee, and a curated tobacco selection, all in a space designed to make you stay a little longer.', mk: 'BITE го донесува она што на Охрид му недостасуваше — свежи, здрави оброци, внимателно избрано кафе и одбрана селекција на тутун, сè во простор дизајниран да ве задржи малку подолго.' },
  'bite.home.cardBite': { en: 'Bite', mk: 'Bite' },
  'bite.home.cardBiteDesc': { en: 'Fresh salads, wraps, bowls, and light meals — made with local ingredients.', mk: 'Свежи салати, тортиљи, чинии и лесни оброци — направени со локални состојки.' },
  'bite.home.cardBrew': { en: 'Brew', mk: 'Brew' },
  'bite.home.cardBrewDesc': { en: 'Specialty espresso, filter coffee, and refreshing drinks.', mk: 'Специјално еспресо, филтер кафе и освежувачки пијалоци.' },
  'bite.home.cardSmoke': { en: 'Smoke', mk: 'Smoke' },
  'bite.home.cardSmokeDesc': { en: 'A curated selection of premium tobacco for those who appreciate the craft.', mk: 'Одбрана селекција на премиум тутун за оние кои го ценат квалитетот.' },
  'bite.home.cardFresh': { en: 'Fresh', mk: 'Свежо' },
  'bite.home.cardFreshDesc': { en: 'Cold-pressed juices, smoothie bowls, chia meals, and protein shakes — energy in every sip.', mk: 'Свежо цедени сокови, смути чинии, чиа оброци и протеински шејкови — енергија во секое голтче.' },
  'bite.home.tagJuice': { en: 'Fresh Juice', mk: 'Свеж Сок' },
  'bite.home.ctaTitle': { en: 'Come hungry. Leave happy.', mk: 'Дојди гладен. Замини среќен.' },
  'bite.home.ctaDesc': { en: 'Whether you\'re here for the food, the coffee, or just the vibe — we\'re waiting.', mk: 'Без разлика дали си тука за храната, кафето или атмосферата — те чекаме.' },
  'bite.home.ctaMenu': { en: 'See the Menu', mk: 'Погледни мени' },
  'bite.home.ctaVisit': { en: 'Visit Us', mk: 'Посети нè' },
  'bite.home.findUsLabel': { en: 'Find Us', mk: 'Најди нè' },
  'bite.home.findUsTitle': { en: 'Come visit. We\'re easy to find.', mk: 'Дојди. Лесно нè наоѓаш.' },
  'bite.home.phoneLabel': { en: 'Call us', mk: 'Јави се' },
  'bite.home.orderOnline': { en: 'Order Online', mk: 'Нарачај онлајн' },
  'bite.home.woltLabel': { en: 'Delivery', mk: 'Достава' },
  'bite.home.woltTitle': { en: 'Order on Wolt', mk: 'Нарачај на Wolt' },
  'bite.home.woltDesc': { en: 'Can\'t make it to us? Get BITE delivered straight to your door.', mk: 'Не можеш да дојдеш? Нарачај BITE директно до твојата врата.' },
  'bite.home.woltCta': { en: 'Order Now', mk: 'Нарачај сега' },

  // BITE Menu
  'bite.menu.title': { en: 'The Menu', mk: 'Мени' },
  'bite.menu.subtitle': { en: 'Scroll through. Get hungry.', mk: 'Скролај. Огладни.' },
  'bite.menu.sectionBite': { en: 'Bite', mk: 'Bite' },
  'bite.menu.sectionBrew': { en: 'Brew', mk: 'Brew' },
  'bite.menu.sectionSmoke': { en: 'Smoke', mk: 'Smoke' },

  // Bite items
  'bite.menu.bite1.name': { en: 'Green Goddess Bowl', mk: 'Green Goddess Чинија' },
  'bite.menu.bite1.desc': { en: 'Quinoa, avocado, roasted chickpeas, mixed greens, tahini dressing.', mk: 'Киноа, авокадо, печен леблебија, мешана зеленчук, тахини дресинг.' },
  'bite.menu.bite1.detail': { en: 'Vegan · Gluten-free', mk: 'Вегански · Без глутен' },
  'bite.menu.bite2.name': { en: 'Mediterranean Wrap', mk: 'Медитерански Врап' },
  'bite.menu.bite2.desc': { en: 'Grilled chicken, hummus, sun-dried tomatoes, arugula, whole wheat tortilla.', mk: 'Грилувано пилешко, хумус, сушени домати, рукола, целозрнеста тортиља.' },
  'bite.menu.bite2.detail': { en: 'High protein', mk: 'Високо протеинско' },
  'bite.menu.bite3.name': { en: 'Ohrid Garden Salad', mk: 'Охридска Градинарска Салата' },
  'bite.menu.bite3.desc': { en: 'Seasonal local vegetables, feta, olives, herb vinaigrette.', mk: 'Сезонски локален зеленчук, фета, маслинки, зачински винегрет.' },
  'bite.menu.bite3.detail': { en: 'Vegetarian · Local produce', mk: 'Вегетаријанско · Локални производи' },
  'bite.menu.bite4.name': { en: 'Protein Power Bowl', mk: 'Протеинска Чинија' },
  'bite.menu.bite4.desc': { en: 'Brown rice, grilled salmon, edamame, pickled ginger, soy glaze.', mk: 'Кафеав ориз, грилуван лосос, едамаме, мариниран ѓумбир, соја глазура.' },
  'bite.menu.bite4.detail': { en: 'Omega-3 rich', mk: 'Богато со Омега-3' },
  'bite.menu.bite5.name': { en: 'Açaí Smoothie Bowl', mk: 'Açaí Смути Чинија' },
  'bite.menu.bite5.desc': { en: 'Açaí, banana, granola, fresh berries, coconut flakes, honey drizzle.', mk: 'Açaí, банана, гранола, свежи бобинки, кокосови снегулки, мед.' },
  'bite.menu.bite5.detail': { en: 'Antioxidant boost', mk: 'Антиоксидантски бустер' },
  'bite.menu.bite6.name': { en: 'Classic Club Sandwich', mk: 'Класичен Клуб Сендвич' },
  'bite.menu.bite6.desc': { en: 'Turkey, bacon, lettuce, tomato, sourdough bread, house aioli.', mk: 'Мисирка, сланина, зелена салата, домат, кисело тесто леб, домашен ајоли.' },
  'bite.menu.bite6.detail': { en: 'House favorite', mk: 'Омилен на куќата' },

  // Brew items
  'bite.menu.brew1.name': { en: 'Espresso', mk: 'Еспресо' },
  'bite.menu.brew1.desc': { en: 'Single origin, medium roast. Clean, bright, with notes of citrus and chocolate.', mk: 'Едно потекло, средно печење. Чист, светол, со нотки на цитрус и чоколадо.' },
  'bite.menu.brew1.detail': { en: 'Single origin · Ethiopia', mk: 'Едно потекло · Етиопија' },
  'bite.menu.brew2.name': { en: 'Flat White', mk: 'Флет Вајт' },
  'bite.menu.brew2.desc': { en: 'Double ristretto, velvety steamed milk. The coffee-forward classic.', mk: 'Двоен ристрето, кадифена парна млеко. Класика за вистинските кафеџии.' },
  'bite.menu.brew2.detail': { en: 'Milk choice available', mk: 'Избор на млеко' },
  'bite.menu.brew3.name': { en: 'Cold Brew', mk: 'Ладно варено кафе' },
  'bite.menu.brew3.desc': { en: '18-hour steep, served over ice. Smooth, low acidity, naturally sweet.', mk: '18-часовно потопување, сервирано на мраз. Мазно, ниска киселост, природно слатко.' },
  'bite.menu.brew3.detail': { en: 'Summer favorite', mk: 'Летен фаворит' },
  'bite.menu.brew4.name': { en: 'Matcha Latte', mk: 'Матча Лате' },
  'bite.menu.brew4.desc': { en: 'Ceremonial-grade matcha, oat milk, light vanilla. Calm energy.', mk: 'Церемонијален матча, овесно млеко, лесна ванила. Смирена енергија.' },
  'bite.menu.brew4.detail': { en: 'Caffeine alternative', mk: 'Алтернатива на кофеин' },
  'bite.menu.brew5.name': { en: 'Fresh Juice', mk: 'Свеж Сок' },
  'bite.menu.brew5.desc': { en: 'Daily selection — orange, apple-ginger, or seasonal blend. Cold-pressed.', mk: 'Дневна селекција — портокал, јаболко-ѓумбир или сезонски микс. Ладно цедено.' },
  'bite.menu.brew5.detail': { en: 'Cold-pressed · No sugar added', mk: 'Ладно цедено · Без додаден шеќер' },

  // Smoke items
  'bite.menu.smoke1.name': { en: 'Virginia Classic', mk: 'Вирџинија Класик' },
  'bite.menu.smoke1.desc': { en: 'Light-bodied, naturally sweet. A refined Virginia blend with subtle hay notes.', mk: 'Лесно тело, природно слатко. Рафиниран Вирџинија бленд со суптилни нотки на сено.' },
  'bite.menu.smoke1.detail': { en: 'Virginia blend · Light', mk: 'Вирџинија бленд · Лесен' },
  'bite.menu.smoke2.name': { en: 'Balkan Reserve', mk: 'Балкански Резерв' },
  'bite.menu.smoke2.desc': { en: 'Medium-bodied Oriental and Latakia blend. Smoky, earthy, complex.', mk: 'Средно тело, Ориентален и Латакија бленд. Чаден, земјен, комплексен.' },
  'bite.menu.smoke2.detail': { en: 'Oriental-Latakia · Medium', mk: 'Ориентален-Латакија · Среден' },
  'bite.menu.smoke3.name': { en: 'English Morning', mk: 'Англиски Утрински' },
  'bite.menu.smoke3.desc': { en: 'Full-bodied English mixture. Dark-fired Kentucky with a hint of Perique.', mk: 'Полно тело, Англиска мешавина. Темно печен Кентаки со нотка на Перик.' },
  'bite.menu.smoke3.detail': { en: 'English mixture · Full', mk: 'Англиска мешавина · Полно' },
  'bite.menu.smoke4.name': { en: 'Aromatic Vanilla', mk: 'Ароматична Ванила' },
  'bite.menu.smoke4.desc': { en: 'Smooth Cavendish with warm vanilla and a touch of caramel. Room-friendly aroma.', mk: 'Мазен Кавендиш со топла ванила и допир на карамела. Пријатна соба арома.' },
  'bite.menu.smoke4.detail': { en: 'Aromatic · Mild', mk: 'Ароматичен · Благ' },

  'bite.menu.disclaimer': { en: 'Tobacco products are available for adults only. Prices available in store. Smoking is harmful to health.', mk: 'Тутунските производи се достапни само за возрасни. Цените се достапни во продавница. Пушењето е штетно за здравјето.' },
  'bite.menu.currency': { en: 'den', mk: 'ден' },
  'bite.menu.addons': { en: 'Add-ons', mk: 'Додатоци' },

  // BITE Story
  'bite.story.title': { en: 'Our Story', mk: 'Нашата Приказна' },
  'bite.story.lead': { en: 'BITE started with a simple idea — Ohrid deserves a place where healthy food, great coffee, and good company come together.', mk: 'BITE започна со едноставна идеја — Охрид заслужува место каде здравата храна, одличното кафе и доброто друштво се среќаваат.' },
  'bite.story.originLabel': { en: 'The Beginning', mk: 'Почетокот' },
  'bite.story.originTitle': { en: 'Born from appetite.', mk: 'Родено од апетит.' },
  'bite.story.originDesc': { en: 'We opened BITE because we couldn\'t find what we wanted to eat. Ohrid has incredible restaurants, but we craved something lighter, fresher, faster — without sacrificing taste. So we built it.', mk: 'Го отворивме BITE затоа што не можевме да го најдеме она што сакавме да го јадеме. Охрид има неверојатни ресторани, но сакавме нешто полесно, посвежо, побрзо — без да го жртвуваме вкусот. Затоа го изградивме.' },
  'bite.story.sourcingLabel': { en: 'Sourcing', mk: 'Набавки' },
  'bite.story.sourcingTitle': { en: 'Local first. Always.', mk: 'Локално прво. Секогаш.' },
  'bite.story.sourcingDesc': { en: 'Our vegetables come from farms around Ohrid and Resen. Our coffee is roasted in small batches by a specialty roaster. Our tobacco is sourced from established blenders with decades of craft.', mk: 'Нашиот зеленчук доаѓа од фарми околу Охрид и Ресен. Нашето кафе е печено во мали серии од специјален печач. Нашиот тутун е набавен од воспоставени блендери со децении на занаетчиство.' },
  'bite.story.spaceLabel': { en: 'The Space', mk: 'Просторот' },
  'bite.story.spaceTitle': { en: 'Designed to linger.', mk: 'Дизајниран за задржување.' },
  'bite.story.spaceDesc': { en: 'Natural light, warm materials, and a layout that invites you to stay. Whether you\'re working on a laptop, catching up with friends, or just watching the afternoon pass — there\'s a seat for you.', mk: 'Природна светлина, топли материјали и распоред кој те кани да останеш. Без разлика дали работиш на лаптоп, се среќаваш со пријатели или само го гледаш попладнето — има место за тебе.' },
  'bite.story.value1Title': { en: 'Fresh over fast.', mk: 'Свежо пред брзо.' },
  'bite.story.value1Desc': { en: 'Everything is made to order. It takes a few minutes longer, but it\'s worth it.', mk: 'Сè е направено по нарачка. Трае неколку минути подолго, но вреди.' },
  'bite.story.value2Title': { en: 'Simple ingredients.', mk: 'Едноставни состојки.' },
  'bite.story.value2Desc': { en: 'No shortcuts, no artificial anything. You can taste the difference.', mk: 'Без кратенки, без вештачко. Можеш да ја почувствуваш разликата.' },
  'bite.story.value3Title': { en: 'Community space.', mk: 'Простор за заедница.' },
  'bite.story.value3Desc': { en: 'BITE is a gathering point — for locals, travelers, and everyone in between.', mk: 'BITE е точка на собирање — за локалци, патници и сите помеѓу.' },

  // BITE Visit
  'bite.visit.title': { en: 'Visit Us', mk: 'Посети нè' },
  'bite.visit.addressLabel': { en: 'Address', mk: 'Адреса' },
  'bite.visit.address': { en: 'Ohrid, North Macedonia', mk: 'Охрид, Северна Македонија' },
  'bite.visit.hoursLabel': { en: 'Hours', mk: 'Работно време' },
  'bite.visit.hours': { en: 'Mon–Sun: 8:00 – 23:00', mk: 'Пон–Нед: 8:00 – 23:00' },
  'bite.visit.phoneLabel': { en: 'Phone', mk: 'Телефон' },
  'bite.visit.phone': { en: '+389 XX XXX XXX', mk: '+389 XX XXX XXX' },
  'bite.visit.socialLabel': { en: 'Instagram', mk: 'Instagram' },
  'bite.visit.note': { en: 'Part of the Park Diamond Apartments complex. Guests get 10% off all food and coffee.', mk: 'Дел од комплексот Park Diamond Apartments. Гостите добиваат 10% попуст на храна и кафе.' },

  // BITE cross-link on PD home
  'bite.promo.title': { en: 'Hungry?', mk: 'Гладен?' },
  'bite.promo.desc': { en: 'BITE — healthy food, great coffee, and more. Right here at Park Diamond.', mk: 'BITE — здрава храна, одлично кафе и повеќе. Токму тука во Park Diamond.' },
  'bite.promo.cta': { en: 'Visit BITE', mk: 'Посети BITE' },
